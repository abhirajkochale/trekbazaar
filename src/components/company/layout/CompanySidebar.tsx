...
const navItems = [
  ...
  { name: "Treks", href: "/company/treks", icon: Map },
  ...
  return (
    <div className="h-full flex flex-col bg-zinc-50/50">
      ...
      <div className="h-16 flex-shrink-0 flex items-center px-6">
        <Link href="/company" className="flex items-center gap-3 text-zinc-900 group">
      ...
      <nav className="flex-1 overflow-y-auto py-2 px-3 space-y-0.5">
        ...
        >
          <Building2 className={`w-4 h-4 ${pathname.startsWith('/company/profile') ? 'text-tb-primary' : 'text-zinc-400'}`} />
          Company Profile
        </Link>
      </nav>
