    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <Link href="/company/departures/new" className="shrink-0">
                  ...
                  {sortedDepartures.map(dep => {
                    ...
                    return (
                      <tr key={dep.id} className="hover:bg-zinc-50/50 transition-colors group">
                        ...
                        <td className="px-6 py-4">
                          <Link href={`/company/treks/${dep.trek_id}/edit`} className="font-bold text-sm text-zinc-900 hover:text-tb-primary transition-colors">
                            {dep.treks?.title}
                          </Link>
                        </td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            <Link href={`/company/departures/${dep.id}/edit`} className="w-8 h-8 rounded-lg bg-white border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 shadow-sm transition-all" title="Edit">
                              <Edit2 className="w-4 h-4" />
                            </Link>
                            <Link href={`/company/departures/new?duplicate=${dep.id}`} className="w-8 h-8 rounded-lg bg-white border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 shadow-sm transition-all" title="Duplicate">
               ...
               return (
                <div key={dep.id} className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Link href={`/company/departures/${dep.id}/edit`} className="flex-1 text-center text-xs font-bold text-zinc-700 bg-white border border-zinc-200 hover:bg-zinc-50 px-3 py-2 rounded-lg transition-colors">
                      Edit
                    </Link>
                    <Link href={`/company/departures/new?duplicate=${dep.id}`} className="flex-1 text-center text-xs font-bold text-zinc-700 bg-white border border-zinc-200 hover:bg-zinc-50 px-3 py-2 rounded-lg transition-colors flex items-center justify-center gap-1">
