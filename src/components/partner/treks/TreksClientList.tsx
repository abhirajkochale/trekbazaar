    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <Link href="/partner/dashboard/treks/new" className="shrink-0">
                    ...
                    <tr key={trek.id} className="hover:bg-zinc-50/50 transition-colors group">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <Link href={`/partner/dashboard/treks/${trek.id}/edit`} className="font-bold text-sm text-zinc-900 hover:text-tb-primary transition-colors line-clamp-1">
                              {trek.title}
                            </Link>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <Link href={`/partner/dashboard/treks/${trek.id}/edit`} className="w-8 h-8 rounded-lg bg-white border border-zinc-200 flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 shadow-sm transition-all" title="Edit">
              ...
              <div key={trek.id} className="bg-white border border-zinc-200 rounded-2xl p-4 shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <Link href={`/partner/dashboard/treks/${trek.id}/edit`} className="text-xs font-bold text-tb-primary bg-tb-primary/10 px-3 py-1.5 rounded-lg">
                      Edit
                    </Link>
                  </div>
                </div>
